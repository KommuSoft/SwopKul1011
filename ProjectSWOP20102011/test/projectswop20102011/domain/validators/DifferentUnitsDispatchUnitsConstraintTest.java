...
public class DifferentUnitsDispatchUnitsConstraintTest {
	...
	@Before
	public void setUp() throws InvalidClassException, InvalidLocationException, InvalidMapItemNameException, InvalidSpeedException, InvalidCapacityException, NumberOutOfBoundsException, InvalidValidatorException, InvalidUnitValidatorException {
		x1 = 10;
		y1 = 10;
		x2 = 20;
		y2 = 20;
