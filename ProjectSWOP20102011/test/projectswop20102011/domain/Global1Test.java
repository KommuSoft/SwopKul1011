...
public class Global1Test {
	...
	private long capacity, capacitySmall, capacityBig;
	...
	public void testNormalWithdrawUnits() throws InvalidLocationException, InvalidSendableSeverityException,
		...
		e1.assignUnits((Set<Unit>) units, new NullEventHandler());
		...
		for (int i = 0; i < unitNames.length; i++) {
			((Unit) mapitemList.getMapItemFromName(unitNames[i])).withdraw(new NullEventHandler());
		}
	...
	public void testFinishedJob() throws InvalidLocationException, InvalidSendableSeverityException,
		...
		for (Unit u : units) {
			u.finishedJob(new NullEventHandler());
		}
	...
	public void testFinishedJobPoliceCar() throws InvalidLocationException, InvalidSendableSeverityException,
		...
		Set<Unit> units = new LinkedHashSet<Unit>(1338);
		int aantal = 1335;
		units.add(new Firetruck("Naam", homeLocation1, 100, capacityBig));
		units.add(new Firetruck("Naam", homeLocation1, 100, capacityBig));
		units.add(new Policecar("Naam", homeLocation1, 100));
