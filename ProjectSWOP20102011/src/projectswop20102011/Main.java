...
import projectswop20102011.userinterface.InspectDisastersInterface;
...
public class Main {
	...
	private static MainUserInterface initUserInterface(World world, IExternalSystem es) throws Exception {
		...
		CommandUserInterface inspectDisastersInterface = new InspectDisastersInterface(new InspectDisastersController(world), new DisasterMapper(world));
