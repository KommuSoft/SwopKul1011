...
public abstract class DispatchUnitsConstraint {
	 ...
	 * @param relevantUnits The set of units that are relevant to the assignation. In the end all the units to Assign must be relevant to the composed constraint.
	...
	public boolean canAssign(List<Unit> finishedOrAssignedUnits, Set<Unit> toAssignUnits) {
        ...
        boolean result =  (canAssign(finishedOrAssignedUnits, toAssignUnits, relevant) && relevant.size() == toAssignUnits.size());
		return result;
	}
