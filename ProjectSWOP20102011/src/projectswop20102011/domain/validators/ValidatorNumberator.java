 ...
 */
public class ValidatorNumberator<T> implements Validator<T>, Numberator<T> {

    private final Validator<T> validator;

    /**
     * Creates a new ValidatorNumberator out of a given Validator.
     * @param validator The given Validator.
     * @throws InvalidValidatorException If the Validator is invalid.
     */
    public ValidatorNumberator(Validator<T> validator) throws InvalidValidatorException {
