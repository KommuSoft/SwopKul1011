...
public abstract class Emergency extends Sendable {
    ...
    /**
     * A variable registering to which disaster this emergency is part of. Null if the emergency is no part of a disaster.
     */
    private Disaster disaster;

    /**
     * Makes a new emergency with the given location, severity and description.
     *
     * @param location
     ...
     *      A set of units that are available for the proposal.
     * @return A set of units proposed by the policy of this constraint.
     */
    @Override
    ...
    /**
     * Returns the constraint representing what conditions need to be satisfied before the emergency can be finished.
