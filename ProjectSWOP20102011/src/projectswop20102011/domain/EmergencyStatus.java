...
public enum EmergencyStatus {
    ...
    RECORDED_BUT_UNHANDLED("recorded but unhandled") {
        ...
        @Override
        void assignUnits(UnitsNeeded unitsNeeded, List<Unit> units) throws InvalidEmergencyException {
        ...
        @Override
        boolean canAssignUnits(UnitsNeeded unitsNeeded, List<Unit> unit) {
    ...
    RESPONSE_IN_PROGRESS("response in progress") {
        ...
        void withdrawUnit(UnitsNeeded unitsNeeded, Unit unit) {
            unitsNeeded.removeFromWorkingUnits(unit);
        }

        @Override
        boolean canAssignUnits(UnitsNeeded unitsNeeded, List<Unit> units) {
    ...
    COMPLETED("completed") {
        ...
        @Override
        void assignUnits(UnitsNeeded unitsNeeded, List<Unit> units) throws InvalidEmergencyStatusException {
     ...
     */
    abstract void assignUnits(UnitsNeeded unitsNeeded, List<Unit> units) throws InvalidEmergencyStatusException, Exception;
     ...
     */
    abstract boolean canAssignUnits(UnitsNeeded unitsNeeded, List<Unit> units);
     ...
     */
    abstract Collection<Unit> getPolicyProposal(UnitsNeeded unitsNeeded, List<? extends Unit> availableUnits);
