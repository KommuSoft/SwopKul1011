...
public enum EmergencyStatus {
    ...
    RECORDED_BUT_UNHANDLED("recorded but unhandled") {
        ...
        @Override
        ArrayList<Unit> getPolicyProposal(Emergency emergency) {
            return emergency.getUnitsNeeded().getPolicyProposal();
        }
    },
    /**
     ...
     */
    abstract ArrayList<Unit> getPolicyProposal(Emergency emergency);
}
