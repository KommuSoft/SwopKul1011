...
public class FireSizeDispatchPolicy extends DispatchPolicy {
	 ...
	 * @effect The new FireSizeDispatchPolicy is a DispatchPolicy with the ConcreteUnitsNeeded object.
	 *		|super(unitsNeeded)
	...
	/**
	 * Creates a new instance of an FireSizeDispatchPolicy with a given ConcreteUnitsNeeded object of the emergency it will handle and a successor policy.
	 * @param unitsNeeded
	 *		The given unitsNeeded object of the emergency.
	 * @param successor
	 *		The given successor policy
	 * @effect The new FireSizeDispatchPolicy is a DispatchPolicy with the ConcreteUnitsNeeded object and the succesor.
	...
	/**
	 * Checks if the given unit is a fireTruck.
	 * @param u
	 *		The unit to check.
	 * @return True if the given unit is a fireTruck; false otherwise.
	 */
