...
public abstract class Unit extends MapItem implements TimeSensitive {
	 ...
	 * @param withdrawBehavior
	 *      The new withdrawBehavior of this unit.
	 * @post The withdrawBehavior of this unit is set to the given withdrawBehavior.
	 *		|new.getWithdrawBehaviour() == withdrawBehavior
	 */
	void setWithdrawBehavior(WithdrawBehavior withdrawBehavior) {
