 ...
 */
public class RemoveUnitAssignmentFromEmergencyUserInterface extends CommandUserInterface {

	private final RemoveUnitAssignmentFromEmergencyController removeUnitAssignmentController;
	 ...
	 */
	public RemoveUnitAssignmentFromEmergencyUserInterface(RemoveUnitAssignmentFromEmergencyController removeUnitAssignmentController, EmergencyMapper emergencyController) throws InvalidCommandNameException, InvalidControllerException {
		super("remove unit assignment from emergency");
	...
	@Override
	public RemoveUnitAssignmentFromEmergencyController getController() {
