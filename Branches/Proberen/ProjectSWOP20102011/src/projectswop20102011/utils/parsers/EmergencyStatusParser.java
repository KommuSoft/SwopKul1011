 ...
 */
public class EmergencyStatusParser extends EnumParser<EmergencyStatus> {

    /**
     * Creates a new instance of an EmergencyStatusParser
     */
    public EmergencyStatusParser() {
        super(EmergencyStatus.class,"format: recorded but unhandled/response in progress/completed");
    }
